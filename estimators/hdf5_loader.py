...
class DataIterator(object):
    ...
    def GetFilePaths(self):
        ...
        if self.mode == 'train': 
            train_files = [os.path.join('processed_acdc_dataset/hdf5_files','train_set',f) 
                        for f in os.listdir(os.path.join('processed_acdc_dataset/hdf5_files','train_set'))]
            ...
            valid_files = [os.path.join('processed_acdc_dataset/hdf5_files','validation_set',f) 
                        for f in os.listdir(os.path.join('processed_acdc_dataset/hdf5_files','validation_set'))]
